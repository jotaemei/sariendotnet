...
var Canvas =
{
  ...
  load: function(id, withoutFill) {
    ...
    // check for errors in fill, if the four corner pixels are 3, then redraw without filling
    if (!withoutFill) {
      var p1 = Canvas.getPixel(0, 0);
      var p2 = Canvas.getPixel(159, 0);
      var p3 = Canvas.getPixel(0, 167);
      var p4 = Canvas.getPixel(159, 167);
